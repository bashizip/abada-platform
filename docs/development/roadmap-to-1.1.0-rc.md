...
This roadmap follows the `1.0.0-rc.3` reliable OSS core. Its primary product
...
The `1.0.0-rc.3` Compose family remains the supported evaluation and
...
These items are intentionally deferred from the `1.0.0-rc.3` release
candidate.
