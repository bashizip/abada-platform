...
Status: prepared candidate. Publication is gated by the rc.6 gate report and
the M1 exit demo (`docs/development/1.0-rc-publication-gates.md`).
...
- The PDF product brief has no source in this repository and must be corrected
  by hand to match these notes.
