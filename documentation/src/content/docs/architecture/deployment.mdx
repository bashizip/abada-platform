...
| --- | --- | --- |
| `compose.yaml` | PostgreSQL, Engine, Studio, Docs, internal data and edge networks, persistent workflow/log volumes | Identity provider, TLS policy, telemetry backends |
