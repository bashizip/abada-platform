...
`abada:decisionTable`, exclusive/inclusive/parallel gateways, and
message/signal/duration-timer catch events. Event-based gateways are limited
to one outgoing catch event.
...
rather than treated as ambiguous pass-through nodes.
