...
<Aside type="note">
  ...
  reference](https://github.com/bashizip/abada-engine/blob/dev/docs/reference/insight-loop.md)
  and [ADR-003](https://github.com/bashizip/abada-engine/blob/dev/docs/adr/ADR-003-insight-loop-engine-otel-apl.md).
