...
<Aside type="note">
  ...
  reference](https://github.com/bashizip/abada-platform/blob/dev/docs/reference/agent-worker.md)
  and [external-worker protocol
  v1](https://github.com/bashizip/abada-platform/blob/dev/docs/reference/external-worker-protocol-v1.md).
