...
<CardGrid>
  ...
  <LinkCard title="APL technical specification" href="https://github.com/bashizip/abada-engine/blob/dev/docs/reference/apl-specification.md" />
  <LinkCard title="APL node reference" href="https://github.com/bashizip/abada-engine/blob/dev/docs/reference/apl-node-reference.md" />
