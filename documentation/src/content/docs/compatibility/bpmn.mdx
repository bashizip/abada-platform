...
<Aside type="note">
  ...
  ADR](https://github.com/bashizip/abada-engine/blob/dev/docs/adr/ADR-001-bpmn-dialects-and-vendor-compatibility.md),
  the [BPMN support contract](https://github.com/bashizip/abada-engine/blob/dev/docs/reference/bpmn-support.md)
