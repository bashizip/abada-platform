---
title: API, worker, agent and Insight contracts
description: Compatibility rules for REST API v1, worker protocol v1, the abada.agent/v1 profile and the Insight API.
---
...
The agent profile is **additive** to worker protocol v1. Locked tasks for
...
Insight endpoints are **additive** to API v1 and follow the same
